...
class UserService extends Service implements UserServiceInterface
{
    ...
    {    
        ...
        if(!$this->isManualRegistration($request)) {
            $this->loginUser($user);
    ...
    private function isManualRegistration(RegisterRequest $request): bool
    {
        return (bool) Arr::get($request, 'manual_registration');
    }
    ...
    {
        return $this->userRepository->getAllPaginatedUsers();
    }
}